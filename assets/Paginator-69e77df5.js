import{r as se,n as O,x as ve,y as pe,j as y,L as xe,C as ye,D as Ce,G as Pe,R as U}from"./index-afa0e541.js";import{a as ke,b as we}from"./favoriteSelectors-b4361c0f.js";import{N as Le}from"./NotFound-96365374.js";function Ve(){const[s,m]=se.useState();return se.useEffect(()=>{function f(){window.innerWidth<1438?m(4):m(9)}return window.addEventListener("resize",f),f(),()=>{window.removeEventListener("resize",f)}},[]),s}const Ne="/drinkMaster-Team-1/assets/trash-fc07c8dc.svg",Oe=O.ul`
  padding: 0;
  margin: 0;
  margin-top: 40px;
...
`;var de={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},ue=U.createContext&&U.createContext(de),q=globalThis&&globalThis.__assign||function(){return q=Object.assign||function(s){for(var m,f=1,b=arguments.length;f<b;f++){m=arguments[f];for(var C in m)Object.prototype.hasOwnProperty.call(m,C)&&(s[C]=m[C])}return s},q.apply(this,arguments)},He=globalThis&&globalThis.__rest||function(s,m){var f={};for(var b in s)Object.prototype.hasOwnProperty.call(s,b)&&m.indexOf(b)<0&&(f[b]=s[b]);if(s!=null&&typeof Object.getOwnPropertySymbols=="function")for(var C=0,b=Object.getOwnPropertySymbols(s);C<b.length;C++)m.indexOf(b[C])<0&&Object.prototype.propertyIsEnumerable.call(s,b[C])&&(f[b[C]]=s[b[C]]);return f};function fe(s){return s&&s.map(function(m,f){return U.createElement(m.tag,q({key:f},m.attr),fe(m.child))})}function me(s){return function(m){return U.createElement(qe,q({attr:q({},s.attr)},m),fe(s.child))}}function qe(s){var m=function(f){var b=s.attr,C=s.size,v=s.title,F=He(s,["attr","size","title"]),c=C||f.size||"1em",l;return f.className&&(l=f.className),s.className&&(l=(l?l+" ":"")+s.className),U.createElement("svg",q({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},f.attr,b,F,{className:l,style:q(q({color:s.color||f.color},f.style),s.style),height:c,width:c,xmlns:"http://www.w3.org/2000/svg"}),v&&U.createElement("title",null,v),s.children)};return ue!==void 0?U.createElement(ue.Consumer,null,function(f){return m(f)}):m(de)}function Fe(s){return me({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0V0z",opacity:".87"}},{tag:"path",attr:{d:"M17.51 3.87L15.73 2.1 5.84 12l9.9 9.9 1.77-1.77L9.38 12l8.13-8.13z"}}]})(s)}function We(s){return me({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0V0z"}},{tag:"path",attr:{d:"M6.23 20.23L8 22l10-10L8 2 6.23 3.77 14.46 12z"}}]})(s)}const Ge=({handlePageClick:s,pageCount:m})=>y.jsx(y.Fragment,{children:!!(m-1)&&y.jsx(Me,{breakLabel:"...",nextLabel:y.jsx(We,{fill:"rgba(243, 243, 243, 0.30)",size:15}),onPageChange:s,pageCount:m,previousLabel:y.jsx(Fe,{fill:"rgba(243, 243, 243, 0.30)",size:15}),renderOnZeroPageCount:null,onPageActive:window.scrollTo({top:0,behavior:"smooth"})})});export{Ze as D,Ge as P,Ve as u};
