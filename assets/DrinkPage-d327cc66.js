import{l as j,c as n,j as t,r as c,o as h}from"./index-09101ffb.js";import{s,P as w}from"./styled-components.browser.esm-2af39d41.js";import{b}from"./operationsDrinks-69f00868.js";async function f(e){try{const i=e.map(async r=>await j.get(`/ingredients/${r}`));return await Promise.all(i)}catch(i){console.log(i.message)}}const k=s.li`
  display: flex;
