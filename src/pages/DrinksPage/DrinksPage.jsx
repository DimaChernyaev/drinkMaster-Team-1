...
// import Loader from ''
import { Container, Title, } from '../FavoriteDrinksPage/FavoriteDrinksPage.styled';
...
// Сторінка Drinks: рендерить компонент Filter, список карток паноїв, компонент Paginator
        ...
        const DrinksPage = () => {
                ...
                const [per_page, setPerPage] = useState((window.innerWidth > 1439) && 9 || 10);
                ...
                return ( 
                        <Container>
                                ...
                                <Title> <h1>Drinks</h1> </Title>

                                <Filter categoryList ={categoryList} ingredientList ={ingredientList} onChangeFilter = {getPopularDrinks}/>
