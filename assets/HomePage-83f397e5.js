import{n as i,L as l,c,j as t,r as d}from"./index-cd633c6a.js";import{g as k}from"./operationsDrinks-7fec7844.js";const m=i.li``,h=i.img`
  display: block;
  border-radius: 8px;
...
`,g=({_id:n,drink:s,drinkThumb:r})=>t.jsxs(m,{children:[t.jsx(h,{src:r,alt:s}),t.jsxs(b,{children:[t.jsx(_,{children:s}),t.jsx(p,{to:`drink/${n}`,children:"See more"})]})]},n),f=i.ul`
  display: flex;
  gap: 20px;
...
`,w=i.h2`
  ...
  font-size: 40px;
  font-weight: 600;
`,j=({drinks:n})=>t.jsx(t.Fragment,{children:n.map(([s,r])=>t.jsxs("div",{children:[t.jsx(w,{children:s}),t.jsx(f,{children:r.map(({_id:o,drink:a,drinkThumb:x})=>t.jsx(g,{_id:o,drink:a,drinkThumb:x}))})]}))}),u=i.div`
  display: flex;
