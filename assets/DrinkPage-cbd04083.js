import{l as j,c as n,j as t,r as c,o as h}from"./index-8ad2a130.js";import{s,P as w}from"./styled-components.browser.esm-e515440c.js";import{b}from"./operationsDrinks-4ac9bd98.js";async function f(e){try{const i=e.map(async r=>await j.get(`/ingredients/${r}`));return await Promise.all(i)}catch(i){console.log(i.message)}}const k=s.li`
  display: flex;
