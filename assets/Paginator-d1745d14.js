...
`,Re=({handlePageClick:s,pageCount:b})=>X.jsx(X.Fragment,{children:!!(b-1)&&X.jsx(Oe,{breakLabel:"...",nextLabel:X.jsx(we,{}),onPageChange:s,pageCount:b,previousLabel:X.jsx(Ne,{}),renderOnZeroPageCount:null,onPageActive:window.scrollTo({top:0,behavior:"smooth"})})});export{Re as P};
