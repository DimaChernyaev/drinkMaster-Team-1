import{s as i,c as r,r as l,j as t,u as K,b as Q,d as Z,e as ee,f as w,g as oe,h as te,i as ie,M as ne,k as L,F as T,S as re,l as se,m as ae,L as le}from"./index-483fb437.js";import{g as ce,b as de,a as pe}from"./operationsFilters-ce104ce5.js";import{S as R}from"./react-select.esm-4590db6a.js";import{b as he}from"./operationsDrinks-c70953ac.js";const xe=i.button`
  margin-top: 20px;
...
`,Ve=({values:o,errors:a,touched:e,handleChange:n,handleBlur:d,setFieldValue:p})=>{const[x,F]=l.useState([]),[y,b]=l.useState([]),[u,k]=l.useState([]),[W,C]=l.useState([]);l.useEffect(()=>{async function s(){try{const I=(await ce()).map(v=>({value:v,label:v}));F(I)}catch(j){console.error("Ошибка при загрузке категорий:",j)}}async function f(){try{const I=(await de()).map(v=>({value:v,label:v}));k(I)}catch(j){console.error("Ошибка при загрузке категорий:",j)}}s(),f()},[]);const[h,c]=l.useState(null),[m,g]=l.useState(!1),[z,S]=l.useState(!1),[N,M]=l.useState(!1),[G,q]=l.useState(!1),H=s=>{const f=s.target.files[0];p("drinkThumb",f),c(f?URL.createObjectURL(f):null)},U=()=>{document.getElementById("drinkThumb").click()},_=s=>{const{value:f}=s.target;S(f.trim().length>1)},J=s=>{const{value:f}=s.target;q(f.trim().length>25)},X=s=>{b(s),p("category",s.value)},Y=s=>{C(s),p("glass",s.value)};return t.jsxs(ge,{children:[t.jsxs(me,{onClick:U,children:[t.jsxs(be,{children:[t.jsx(we,{type:"file",id:"drinkThumb",name:"drinkThumb",onChange:s=>H(s),accept:"drinkThumb/*"}),t.jsx($e,{htmlFor:"drinkThumb",children:t.jsx(Fe,{})})]}),t.jsx("p",{children:"Add image"}),h&&t.jsx(fe,{src:h,alt:"Selected"}),e.drinkThumb&&a.drinkThumb?t.jsx($,{children:a.drinkThumb}):null]}),t.jsxs(ye,{children:[t.jsxs(ke,{children:[t.jsx(V,{htmlFor:"drink",$isFocused:m,$hasValue:z,children:"Enter item title"}),t.jsx(je,{type:"text",id:"drink",name:"drink",onChange:s=>{_(s),n(s)},onBlur:s=>{g(!1),d(s)},onFocus:()=>g(!0),value:o.drink,placeholder:" "}),e.drink&&a.drink?t.jsx($,{children:a.drink}):null]}),t.jsxs(ve,{children:[t.jsx(B,{htmlFor:"description",$isFocusedDescription:N,$hasValueDescription:G,children:"Enter about recipe"}),t.jsx(We,{rows:1,maxLength:234,id:"description",name:"description",onChange:s=>{J(s),n(s)},onBlur:s=>{M(!1),d(s)},onFocus:()=>M(!0),value:o.description,placeholder:" "}),e.description&&a.description?t.jsx($,{children:a.description}):null]}),t.jsxs(Ce,{children:["Category",t.jsx(Se,{htmlFor:"category"}),t.jsx(De,{name:"category",options:x,value:y,onChange:s=>X(s),placeholder:""})]}),e.category&&a.category?t.jsx($,{children:a.category}):null,t.jsxs(ze,{children:["Glass",t.jsx(Ie,{htmlFor:"glass"}),t.jsx(Le,{name:"glass",options:u,value:W,onChange:s=>Y(s),placeholder:""})]}),e.glass&&a.glass?t.jsx($,{children:a.glass}):null,t.jsxs(Te,{children:[t.jsxs(P,{className:o.alcoholic==="Alcoholic"?"checked":"",children:[t.jsx(D,{type:"radio",name:"alcoholic",value:"Alcoholic",checked:o.alcoholic==="Alcoholic",onChange:n}),t.jsx(O,{}),"Alcoholic"]}),t.jsxs(P,{className:o.alcoholic==="Non alcoholic"?"checked":"",children:[t.jsx(D,{type:"radio",name:"alcoholic",value:"Non alcoholic",checked:o.alcoholic==="Non alcoholic",onChange:n}),t.jsx(O,{}),"Non-alcoholic"]}),e.alcoholic&&a.alcoholic?t.jsx($,{children:a.alcoholic}):null]})]})]})},Be=o=>l.createElement("svg",{width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...o},l.createElement("path",{d:"M2.5 8H13.5",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"}),l.createElement("path",{d:"M8 2.5V13.5",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"})),Re=o=>l.createElement("svg",{width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...o},l.createElement("path",{d:"M2.5 8H13.5",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"})),Ee=o=>l.createElement("svg",{width:20,height:20,viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",...o},l.createElement("path",{d:"M15.625 4.375L4.375 15.625",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"}),l.createElement("path",{d:"M15.625 15.625L4.375 4.375",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"})),Me=i.div`
  flex-basis: 100%;
  font-size: 12px;
  color: #da1414;
  line-height: 14px;
