import{n as i,L as c,j as t,c as l,r as d}from"./index-b3ac079c.js";import{g as x}from"./operationsDrinks-4e6226e9.js";const m=i.li`
...
`,y=({_id:s,drink:n,drinkThumb:r})=>t.jsxs(m,{children:[t.jsx(p,{src:r,alt:n}),t.jsxs(k,{children:[t.jsx(w,{children:n}),t.jsx(_,{to:`drink/${s}`,children:"See more"})]})]},s),b=i.ul`
  display: flex;
  gap: 20px;
...
`,f=i.h2`
  ...
  font-size: 40px;
  font-weight: 600;
`,g=({drinks:s})=>t.jsx(t.Fragment,{children:s.map(([n,r])=>t.jsxs("div",{children:[t.jsx(f,{children:n}),t.jsx(b,{children:r.map(({_id:o,drink:a,drinkThumb:h})=>t.jsx(y,{_id:o,drink:a,drinkThumb:h},o))})]},n))}),j=i.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 80px;
